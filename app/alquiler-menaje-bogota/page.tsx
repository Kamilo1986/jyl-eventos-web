    ...
    <>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1>
            ...
            Alquiler de Menaje Premium en Bogotá
          ...
          <p>
            ...
            En J&L Eventos Premium ofrecemos
            alquiler de menaje completo en Bogotá:
            vajillas, cristalería, mesas, sillas
            y decoración elegante.

            Garantizamos montaje profesional,
            puntualidad y asesoría personalizada
            para eventos corporativos y sociales.
        ...
        <div className={styles.visualContainer}>
          ...
          <div className={styles.visualText}>
            ...
            <p>
              ...
              Diseñamos montajes exclusivos
              con menaje premium para crear
              eventos únicos en Bogotá.
      ...
      <section className={styles.content}>
        ...
        <div className={styles.container}>
          ...
          <h2>
            Menaje para Eventos Corporativos
            en Bogotá
          </h2>

          <p>

            Equipamos lanzamientos de marca,
            conferencias, reuniones empresariales,
            eventos ejecutivos y activaciones
            corporativas con menaje premium
            y decoración profesional.

          </p>

          <h2>
            Menaje para Eventos Sociales
            en Bogotá
          </h2>

          <p>

            Creamos experiencias elegantes para
            cumpleaños, 15 años, aniversarios,
            grados y celebraciones privadas.
          ...
          <ul>
            ...
            <li>
              Más de 300 eventos realizados
              en Bogotá
            </li>

            <li>
              Menaje premium y decoración elegante
            </li>

            <li>
              Entrega puntual y montaje profesional
            </li>
            ...
            <li>
              Asesoría personalizada para cada evento
            </li>

          </ul>

          <h2>
            Cobertura de alquiler de menaje
            en Bogotá
          </h2>
          ...
          <p>
            ...
            Salitre, Suba, Centro y municipios
            cercanos.
