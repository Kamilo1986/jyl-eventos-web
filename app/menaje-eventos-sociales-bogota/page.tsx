...
export default function SocialesLanding() {
  ...
  const schema = {
    ...
    name:
      "Menaje para Eventos Sociales en Bogotá",
    ...
    serviceType:
      "Alquiler de menaje para eventos sociales",
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1>
            ...
            para Eventos Sociales en Bogotá

          </h1>

          <p>

            Ofrecemos alquiler de copas,
            vajillas, cristalería y decoración
            premium para eventos sociales
            en Bogotá como 15 años,
            cumpleaños, aniversarios,
            grados y celebraciones privadas.

            Creamos ambientes elegantes
            con montaje profesional
            y asesoría personalizada.

          </p>

          <a
            href="#formulario-social"
            className={styles.cta}
            aria-label="Cotizar alquiler de menaje para eventos sociales en Bogotá"
          >
      ...
      <section className={styles.visualSection}>
        ...
        <div className={styles.visualContainer}>
          ...
          <div className={styles.visualText}>
            ...
            <h2>
              Celebraciones con Estilo y Elegancia
            </h2>

            <p>

              Creamos experiencias únicas
              con decoración y menaje premium
              para eventos sociales en Bogotá
      ...
      <section className={styles.content}>
        ...
        <div className={styles.container}>
          ...
          <ul>
            ...
            <li>
              ✔ Vajilla fina y cristalería premium
            </li>
            ...
            <li>
              ✔ Atención puntual y profesional
            </li>
          ...
          <h2>
            Eventos Sociales que Atendemos en Bogotá
          </h2>

          <p>

            Atendemos celebraciones como
            15 años, cumpleaños, aniversarios,
            grados, fiestas privadas y todo tipo
            de eventos sociales en Bogotá
            con un estilo premium y decoración exclusiva.
